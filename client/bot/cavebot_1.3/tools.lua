-- tools tab (runtime copy)
setDefaultTab("Tools")

-- Ingame editors removed (Ingame macro editor, Ingame hotkey editor)
-- UI.Separator()
...
-- Zoom buttons removed (Zoom In / Zoom Out)
UI.Separator()
...
UI.TextEdit(storage.autoTradeMessage or "I play Mystovia!", function(widget, text)    
